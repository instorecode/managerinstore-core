...
////        }
//
//        teste(Restrictions.eq(column, t));
//        connectorAndOr = null;
//        not = false;
//        return this;
//    }
...
////        }
//
//        teste(Restrictions.between(column, t1, t2));
//        connectorAndOr = null;
//        not = false;
//        return this;
//    }
...
////        }
//
//        teste(Restrictions.in(column, Arrays.asList(t)));
//        connectorAndOr = null;
//        not = false;
//        return this;
//    }
...
////        }
//
//        teste(Restrictions.gt(column, t));
//        connectorAndOr = null;
//        not = false;
//        return this;
//    }
...
////        }
//
//        teste(Restrictions.ge(column, t));
//        connectorAndOr = null;
//        not = false;
//        return this;
//    }
...
////        }
//
//        teste(Restrictions.lt(column, t));
//        connectorAndOr = null;
//        not = false;
//        return this;
//    }
...
////        }
//
//        teste(Restrictions.le(column, t));
//        connectorAndOr = null;
//        not = false;
//        return this;
//    }
...
////            } else {
////                criterionList.add(Restrictions.like(column, t, MatchMode.START));
////            }
////
////        } else {
////            if (criterionList.size() > 0) {
...
////        }
//
//        teste(Restrictions.like(column, t, MatchMode.START));
//        connectorAndOr = null;
//        not = false;
//        return this;
//    }
...
////            } else {
////                criterionList.add(Restrictions.like(column, t, MatchMode.END));
////            }
////
////        } else {
////            if (criterionList.size() > 0) {
...
////        }
//
//        teste(Restrictions.like(column, t, MatchMode.END));
//        connectorAndOr = null;
//        not = false;
//        return this;
//    }
...
////        }
//
//        teste(Restrictions.like(column, t, MatchMode.ANYWHERE));
//        connectorAndOr = null;
//        not = false;
//        return this;
//    }
...
////            } else {
////                criterionList.add(Restrictions.ilike(column, t, MatchMode.START));
////            }
////
////        } else {
////            if (criterionList.size() > 0) {
...
////        }
//
//        teste(Restrictions.ilike(column, t, MatchMode.START));
//        connectorAndOr = null;
//        not = false;
//        return this;
//    }
...
////            } else {
////                criterionList.add(Restrictions.ilike(column, t, MatchMode.END));
////            }
////
////        } else {
////            if (criterionList.size() > 0) {
...
////        }
//
//        teste(Restrictions.ilike(column, t, MatchMode.END));
//        connectorAndOr = null;
//        not = false;
//        return this;
//    }
...
////            }
////        }
//        teste(Restrictions.ilike(column, t, MatchMode.ANYWHERE));
//        connectorAndOr = null;
//        not = false;
//        return this;
//    }
...
////            }
////        }
//        teste(Restrictions.isEmpty(column));
//        connectorAndOr = null;
//        not = false;
//        return this;
//    }
...
////        }
//
//        teste(Restrictions.isNotEmpty(column));
//        connectorAndOr = null;
//        not = false;
//        return this;
//    }
...
////            }
////        }
//        teste(Restrictions.isNull(column));
//        connectorAndOr = null;
//        not = false;
//        return this;
//    }
...
////            }
////        }
//        teste(Restrictions.isNotNull(column));
//        connectorAndOr = null;
//        not = false;
//        return this;
//    }
...
////        if (connectorAndOr == null) {
////            if (not) {
////                criterionList.add(Restrictions.not(Restrictions.le(column, date)));
////            } else {
////                criterionList.add(Restrictions.le(column, date));
////            }
////
////        } else {
////            if (criterionList.size() > 0) {
...
////                    if (not) {
////                        criterionList.remove(criterionList.size() - 1);
////                        criterionList.add(Restrictions.not(Restrictions.and(r, Restrictions.le(column, date))));
////                    } else {
////                        criterionList.remove(criterionList.size() - 1);
////                        criterionList.add(Restrictions.and(r, Restrictions.le(column, date)));
////                    }
////
////                } else {
////                    if (not) {
////                        criterionList.remove(criterionList.size() - 1);
////                        criterionList.add(Restrictions.not(Restrictions.or(r, Restrictions.le(column, date))));
////                    } else {
////                        criterionList.remove(criterionList.size() - 1);
////                        criterionList.add(Restrictions.or(r, Restrictions.le(column, date)));
////                    }
////                }
////            }
////        }
//        teste(Restrictions.le(column, date));
//        connectorAndOr = null;
//        not = false;
//        return this;
//    }
...
////        if (connectorAndOr == null) {
////            if (not) {
////                criterionList.add(Restrictions.not(Restrictions.ge(column, date)));
////            } else {
////                criterionList.add(Restrictions.ge(column, date));
////            }
////        } else {
////            if (criterionList.size() > 0) {
////                Criterion r = criterionList.get(criterionList.size() - 1);
...
////                    if (not) {
////                        criterionList.remove(criterionList.size() - 1);
////                        criterionList.add(Restrictions.not(Restrictions.and(r, Restrictions.ge(column, date))));
////                    } else {
////                        criterionList.remove(criterionList.size() - 1);
////                        criterionList.add(Restrictions.and(r, Restrictions.ge(column, date)));
////                    }
////
////                } else {
////                    if (not) {
////                        criterionList.remove(criterionList.size() - 1);
////                        criterionList.add(Restrictions.not(Restrictions.or(r, Restrictions.ge(column, date))));
////                    } else {
////                        criterionList.remove(criterionList.size() - 1);
////                        criterionList.add(Restrictions.or(r, Restrictions.ge(column, date)));
////                    }
////                }
////            }
////        }
//
//        teste(Restrictions.ge(column, date));
//        connectorAndOr = null;
//        not = false;
//        return this;
//    }
...
//    }
//
//    public <T> Query teste(SimpleExpression se) {
//        if (connectorAndOr == null) {
//            if (not) {
...
//    }
//
//    public <T> Query teste(Criterion criterion) {
//        if (connectorAndOr == null) {
//            if (not) {

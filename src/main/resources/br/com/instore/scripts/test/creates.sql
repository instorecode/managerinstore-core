...
-- -----------------------------------------------------
-- Schema managerinstore2
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `managerinstore2` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `managerinstore2` ;

-- -----------------------------------------------------
-- Table `managerinstore2`.`regiao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `managerinstore2`.`regiao` (
...
-- -----------------------------------------------------
-- Table `managerinstore2`.`estado`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `managerinstore2`.`estado` (
  ...
  CONSTRAINT `fk_estado_regiao1`
    ...
    REFERENCES `managerinstore2`.`regiao` (`idregiao`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `managerinstore2`.`cidade`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `managerinstore2`.`cidade` (
  ...
  CONSTRAINT `fk_cidade_estado1`
    ...
    REFERENCES `managerinstore2`.`estado` (`idestado`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `managerinstore2`.`bairro`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `managerinstore2`.`bairro` (
  ...
  CONSTRAINT `fk_bairro_cidade1`
    ...
    REFERENCES `managerinstore2`.`cidade` (`idcidade`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `managerinstore2`.`cep`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `managerinstore2`.`cep` (
  ...
  CONSTRAINT `fk_cep_bairro1`
    ...
    REFERENCES `managerinstore2`.`bairro` (`idbairro`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `managerinstore2`.`endereco`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `managerinstore2`.`endereco` (
  ...
  CONSTRAINT `fk_endereco_cep1`
    FOREIGN KEY (`idcep`)
    REFERENCES `managerinstore2`.`cep` (`idcep`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `managerinstore2`.`usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `managerinstore2`.`usuario` (
  ...
  CONSTRAINT `fk_usuario_endereco1`
    ...
    REFERENCES `managerinstore2`.`endereco` (`idendereco`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `managerinstore2`.`cliente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `managerinstore2`.`cliente` (
...
-- -----------------------------------------------------
-- Table `managerinstore2`.`perfil`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `managerinstore2`.`perfil` (
...
-- -----------------------------------------------------
-- Table `managerinstore2`.`funcionalidade`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `managerinstore2`.`funcionalidade` (
...
-- -----------------------------------------------------
-- Table `managerinstore2`.`perfil_usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `managerinstore2`.`perfil_usuario` (
  ...
  CONSTRAINT `fk_perfil_usuario_perfil1`
    ...
    REFERENCES `managerinstore2`.`perfil` (`idperfil`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_perfil_usuario_usuario1`
    FOREIGN KEY (`idusuario`)
    REFERENCES `managerinstore2`.`usuario` (`idusuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `managerinstore2`.`perfil_funcionalidade`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `managerinstore2`.`perfil_funcionalidade` (
  ...
  CONSTRAINT `fk_perfil_funcionalidade_funcionalidade1`
    ...
    REFERENCES `managerinstore2`.`funcionalidade` (`idfuncionalidade`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `managerinstore2`.`usuario_cliente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `managerinstore2`.`usuario_cliente` (
  ...
  CONSTRAINT `fk_usuario_empresa_empresa1`
    ...
    REFERENCES `managerinstore2`.`cliente` (`idcliente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `managerinstore2`.`dados_cliente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `managerinstore2`.`dados_cliente` (
...
-- -----------------------------------------------------
-- Table `managerinstore2`.`dados_bancario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `managerinstore2`.`dados_bancario` (
...
-- -----------------------------------------------------
-- Table `managerinstore2`.`boleto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `managerinstore2`.`boleto` (
  ...
  CONSTRAINT `fk_boleto_dados_bancario1`
    ...
    REFERENCES `managerinstore2`.`dados_bancario` (`iddados_bancario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `managerinstore2`.`audiostore_categoria`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `managerinstore2`.`audiostore_categoria` (
...
-- -----------------------------------------------------
-- Table `managerinstore2`.`audiostore_programacao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `managerinstore2`.`audiostore_programacao` (
...
-- -----------------------------------------------------
-- Table `managerinstore2`.`audiostore_programacao_categoria`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `managerinstore2`.`audiostore_programacao_categoria` (
  ...
  CONSTRAINT `fk_audiostore_programacao_categoria_audiostore_categoria1`
    FOREIGN KEY (`codigo`)
    REFERENCES `managerinstore2`.`audiostore_categoria` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_audiostore_programacao_categoria_audiostore_programacao1`
    FOREIGN KEY (`id`)
    REFERENCES `managerinstore2`.`audiostore_programacao` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `managerinstore2`.`config_app`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `managerinstore2`.`config_app` (
  `id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `managerinstore2`.`auditoria`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `managerinstore2`.`auditoria` (
...
-- -----------------------------------------------------
-- Table `managerinstore2`.`auditoria_dados`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `managerinstore2`.`auditoria_dados` (
  ...
  CONSTRAINT `fk_auditoria_colunas_auditoria1`
    ...
    REFERENCES `managerinstore2`.`auditoria` (`idauditoria`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `managerinstore2`.`historico_usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `managerinstore2`.`historico_usuario` (
...
-- -----------------------------------------------------
-- Table `managerinstore2`.`voz`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `managerinstore2`.`voz` (
...
-- -----------------------------------------------------
-- Table `managerinstore2`.`contato_cliente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `managerinstore2`.`contato_cliente` (
  ...
  CONSTRAINT `fk_contato_cliente_dados_cliente1`
    ...
    REFERENCES `managerinstore2`.`dados_cliente` (`iddados_cliente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `managerinstore2`.`audiostore_gravadora`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `managerinstore2`.`audiostore_gravadora` (
...
-- -----------------------------------------------------
-- Table `managerinstore2`.`audiostore_musica`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `managerinstore2`.`audiostore_musica` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_audiostore_musica_audiostoregravadora1`
    ...
    REFERENCES `managerinstore2`.`audiostore_gravadora` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `managerinstore2`.`audiostore_comercial`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `managerinstore2`.`audiostore_comercial` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `managerinstore2`.`audiostore_comercial_sh`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `managerinstore2`.`audiostore_comercial_sh` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_audiostore_comercial_sh_audiostore_comercial1`
    ...
    REFERENCES `managerinstore2`.`audiostore_comercial` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `managerinstore2`.`lancamento_cnpj`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `managerinstore2`.`lancamento_cnpj` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `cnpj` VARCHAR(18) NOT NULL,
  `nome` VARCHAR(255) NOT NULL,
...
-- -----------------------------------------------------
-- Table `managerinstore2`.`lancamento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `managerinstore2`.`lancamento` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_lancamento_lancamento_cnpj1`
    ...
    REFERENCES `managerinstore2`.`lancamento_cnpj` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `managerinstore2`.`lancamento_finalizado`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `managerinstore2`.`lancamento_finalizado` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_lancamento_finalizado_lancamento1`
    ...
    REFERENCES `managerinstore2`.`lancamento` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
